...
const char *onSuccessStart = "\"Successfully invoked device method: Start\"";
const char *onSuccessStop = "\"Successfully invoked device method: Stop\"";
    ...
    void *userContextCallback)
{
    ...
    const char *responseMessage = onSuccessStart;
    int result = 200;

    if (strcmp(methodName, "start") == 0)
    {
        start();
        responseMessage = onSuccessStart;
    }
    else if (strcmp(methodName, "stop") == 0)
    {
        stop();
        responseMessage = onSuccessStop;
    }
    else
    {
